      ...
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
        ...
        <div className="w-[600px] h-[600px] flex items-center">
          <Image
            ...
            width={600}
            height={600}
            className={`w-full ${setting.type === "original" ? "h-full object-contain" : setting.type === "square" ? "aspect-square object-cover" : "aspect-video object-cover"}`}
          />
        </div>
        {/* setting */}
        <div className="flex items-center justify-between text-sm">
          ...
          <div
            className={`cursor-pointer py-1 px-5 rounded-full text-black ${setting.sensitive ? "bg-red-500" : "bg-white"}`}
